...
/*the problem of connecting multiple offices with 
a minimum total cost can be solved by reprenting the 
graph using an appropriate data struture such as an
adjencacy matrix are an  adjecacy list and the applying
a suitable MST algorithm
