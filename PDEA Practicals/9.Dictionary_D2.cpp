...
/* we can use a bst to implement a dictionary with efficient and 
add delete and ubdate opration and the ability to display tha data 
in sorted order the maximum comparison required for finding any key word
is equal to the hright of the tree which is log N for the balance bst
