...
/* the threaded binary tree allows for efficient 
traversal and searching as the threads direct access
to the processor and succesor nodes without the node 
for recurrsion or a stack
